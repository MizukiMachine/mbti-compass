...
# 実行
./target/debug/another-me-ai diagnose
  ...
  build:
    ...
    steps:
      ...
      - name: Upload Artifact
        ...
        with:
          name: another-me-ai-${{ matrix.os }}
          path: target/release/another-me-ai
```
...
# GDB起動
rust-gdb target/debug/another-me-ai
  ...
  "configurations": [
    {
      "type": "lldb",
      "request": "launch",
      "name": "Debug another-me-ai",
      "cargo": {
        "args": ["build", "--bin=another-me-ai"]
      },
      "args": ["diagnose"],
      "cwd": "${workspaceFolder}"
    }
...
sudo cargo flamegraph --bin another-me-ai -- diagnose
